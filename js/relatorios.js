// relatorios.js - Caminhão Vermelho Multi-Tenant
...
function exportarRelatorioVendasNormais() {
    ...
    const { dataInicio, dataFim } = relatoriosData.filtros;
    const filename = `relatorio_vendas_normais_${dataInicio}_${dataFim}`;
...
function exportarRelatorioVendasExtras() {
    ...
    const { dataInicio, dataFim } = relatoriosData.filtros;
    const filename = `relatorio_vendas_extras_${dataInicio}_${dataFim}`;
...
function exportarRelatorioVendasLoja() {
    ...
    const { dataInicio, dataFim } = relatoriosData.filtros;
    const filename = `relatorio_vendas_loja_${dataInicio}_${dataFim}`;
