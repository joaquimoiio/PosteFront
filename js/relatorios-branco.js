// ================================
// RELATÓRIOS CAMINHÃO BRANCO - OTIMIZADO
// ================================

class RelatoriosBranco {
    constructor() {
    ...
    async init() {
        ...
        console.log('✅ Relatórios Branco carregado');
    }
    ...
    exportarRelatorio(tipo = null) {
        ...
        if (tipoExport === 'V') {
            ...
            filename = `vendas_normais_branco_${dataInicio}_${dataFim}`;
        } else {
            dados = vendas.map(v => ({
            ...
            filename = `vendas_${tipoNome}_branco_${dataInicio}_${dataFim}`;
        }
...
// Inicialização
let relatoriosBranco;

document.addEventListener('DOMContentLoaded', () => {
    relatoriosBranco = new RelatoriosBranco();
});

// Funções globais
window.gerarRelatorio = () => relatoriosBranco?.gerarRelatorio();
window.limparRelatorio = () => relatoriosBranco?.limparRelatorio();
window.exportarRelatorio = (tipo) => relatoriosBranco?.exportarRelatorio(tipo);

console.log('✅ Relatórios Branco otimizado carregado');